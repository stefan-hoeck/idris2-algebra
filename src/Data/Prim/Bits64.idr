...
lt : (x,y : Bits64) -> Maybe0 (x < y)
lt x y = case prim__lt_Bits64 x y of
  0 => Nothing0
  _ => Just0 (mkLT unsafeRefl)

public export %inline
lte : (x,y : Bits64) -> Maybe0 (x <= y)
lte x y = case prim__lte_Bits64 x y of
  0 => Nothing0
...
export %inline
Transitive Bits64 (<) where
  transitive _ _ = LT unsafeRefl

export %inline
Trichotomous Bits64 (<) where
...
public export
MaxBits64 : Bits64
MaxBits64 = 0xffff_ffff_ffff_ffff
